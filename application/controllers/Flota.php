...
class Flota extends CI_Controller {
    ...
    public function conductor_create() {
        ...
        $this->form_validation->set_rules('licencia', 'Licencia', 'required|regex_match[/^[0-9]{11}$/]|is_unique[conductores.licencia]');
        $this->form_validation->set_rules('telefono', 'Teléfono', 'required|min_length[10]|max_length[15]');
        $this->form_validation->set_rules('email', 'Email', 'valid_email|is_unique[conductores.email]');
        ...
        $this->form_validation->set_message('is_unique', 'El %s ya está registrado en otro conductor. No puedes repetir el mismo valor.');
