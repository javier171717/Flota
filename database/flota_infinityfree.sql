-- Script SQL para crear la base de datos de la flota de buses en InfinityFree
...
CREATE TABLE IF NOT EXISTS viajes_detalles (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
SELECT 'Base de datos de flota creada exitosamente en InfinityFree' as mensaje;
